  ...
  <b-container>
    ...
    <b-modal id="votemodal" title="VOTING IN COOPERACY" hide-header-close>
      <p>
        ...
        Learn how to influence the whole platform with your personal choices.<br />
        ...
        ><span class="b care">i</span><span class="b transparency">n</span
        ><span class="b freedom">b</span><span class="b understanding">o</span
        ><span class="b diversity">w</span> code through the reaction of the
        other users.<br />
      </p>
      <p>
      ...
      <p>
        It signals trust so the project may skip the business plan budget
        step.<br />
      ...
      <p>
        Follow button, used for becoming a participant/contributor/future
