        ...
        <template v-for="description in this.descriptions">
          <g :key="description.name" :id="description.name" :style="{display: description.display}">
            <a :href="description.href" class="noline finger">
              <text :transform="description.matrix1" fill="#555555" font-size="65">{{description.value}}</text>
              <line :style="description.style" :x1="description.x1" :y1="description.y1" :x2="description.x2" :y2="description.y2" />
              <text :transform="description.matrix2" stroke="#555555" fill="#555555" font-size="25">{{description.text}}</text>
            </a>
          </g>
        </template>
    ...
    data() {
      return {
        ...
        values: [
          ...
          {name: 'care', opacity: 0, animation: '', stroke: 'url(#gcare)', d: 'M645.6213379,590.5565796 c47.1600342-59.1289673,75.3640137-134.0441895,75.3640137-215.5565186c0-26.5563965-3.0014648-52.4103394-8.666748-77.2504272'},
          {name: 'transparency', opacity: 0, animation: '', stroke: 'url(#gtransparency)', d: 'M375,720.9854126 c110,0,207.2280884-50.9467773,270.6212769-130.428833'},
          {name: 'freedom', opacity: 0, animation: '', stroke: 'url(#gfreedom)', d: 'M104.3764725,590.5537109 C167.7696686,670.0374146,265,720.9854126,375,720.9854126'},
          {name: 'understanding', opacity: 0, animation: '', stroke: 'url(#gunderstanding)', d: 'M37.68116,297.7509155 c-5.6650391,24.8396606-8.666441,50.6932373-8.666441,77.2491455c0,81.5109863,28.2031841,156.4251099,75.3618164,215.5536499'},
          {name: 'diversity', opacity: 0, animation: '', stroke: 'url(#gdiversity)', d: 'M224.9472809,63.1593628 C131.433548,108.2390137,61.309639,194.1461182,37.68116,297.7509155'},
        ],
        descriptions: [
          {name: 'equivalenceD', display: 'none', href: 'http://cooperacy.org/cooperation#equivalence', matrix1: 'matrix(1 0 0 1 157 360)', matrix2: 'matrix(1 0 0 1 225 440)', style: 'display:inline;fill:#555555;stroke:#FF8800;stroke-width:6;stroke-miterlimit:10;', x1: '150', y1: '393', x2: '600', y2: '393', text: 'EVERYONE IS IMPORTANT', value: 'EQUIVALENCE'},
          {name: 'trustD', display: 'none', href: 'http://cooperacy.org/cooperation#trust', matrix1: 'matrix(1 0 0 1 278 360)', matrix2: 'matrix(1 0 0 1 208 443)', style: 'display:inline;fill:#555555;stroke:#FFCC00;stroke-width:6;stroke-miterlimit:10;', x1: '150', y1: '393', x2: '600', y2: '393', text: 'PEOPLE COUNT ON OTHERS', value: 'TRUST'},
          ...
          {name: 'understandingD', display: 'none', href: 'http://cooperacy.org/cooperation#understanding', matrix1: 'matrix(1 0 0 1 118 360)', matrix2: 'matrix(1 0 0 1 116 443)', style: 'display:inline;fill:#555555;stroke:#AA66DD;stroke-width:6;stroke-miterlimit:10;', x1: '150', y1: '393', x2: '600', y2: '393', text: 'PEOPLE TRY TO UNDERSTAND EACH OTHER', value: 'UNDERSTANDING'},
          {name: 'diversityD', display: 'none', href: 'http://cooperacy.org/cooperation#diversity', matrix1: 'matrix(1 0 0 1 218 360)', matrix2: 'matrix(1 0 0 1 180 443)', style: 'display:inline;fill:#555555;stroke:#FF77CC;stroke-width:6;stroke-miterlimit:10;', x1: '150', y1: '393', x2: '600', y2: '393', text: 'PEOPLE WANT TO BE INCLUDED', value: 'DIVERSITY'},
        ],
        gradients: [
          {name: "gequivalence", x1: "219", y1: "58", x2: "530", y2: "58", color1: "stop-color:#FF8366", offset: "0.5", color2: "stop-color:#FF8800", color3: "stop-color:#FFC000"},
          {name: "gtrust", x1: "530", y1: "58", x2: "743", y2: "260", color1: "stop-color:#FFC000", offset: "0.5", color2: "stop-color:#FFCC00", color3: "stop-color:#C3DD19"},
          ...
          {name: "gunderstanding", x1: "100", y1: "590", x2: "20", y2: "290", color1: "stop-color:#7777E5", offset: "0.5", color2: "stop-color:#AA66DD", color3: "stop-color:#D46ED4"},
          {name: "gdiversity", x1: "20", y1: "260", x2: "219", y2: "58", color1: "stop-color:#D46ED4", offset: "0.5", color2: "stop-color:#FF77CC", color3: "stop-color:#FF8366"},
        ]
      }  
    },
    mounted() {
