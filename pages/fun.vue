<template>
  <div>
    <br /><img
      class="page-header"
      src="~/assets/image/page/banners/fun.png"
    />
    <br>
    <p class="subheading diversity center space margin">FUN</p>
    <p class="base">Fun and games make us feel together, especially if the gameplay is not too competitive. Fun enhances the bright side of the artistic zest and the power of creative innovation. Art brings our <a
        class="ad"
        href="/cooperation#diversity"
      >diversity</a> to become beauty. Art, fun, games and innovation represent the generative side of our lives. This page is dedicated to fun, creativity and cooperation.</p>

    <br>
    <p class="subheading diversity center space margin">BUILD YOUR OWN PINWHEEL GALAXY</p>
    <p class="base">
      Making a pinwheel is very nice and you can do this little do-it-yourself craft with your friends. The Pinwheel Galaxy is a spiral-shaped galaxy about 21 million light years away from Earth. The first Cooperacy logo was a colorful pinwheel and that idea still lives in the current rotating rainbow circle logo in the homepage. The Cooperacy members chose the pinwheel as the symbol of cooperation because whe the diversity of the colors spins, it becomes a common, intense, white light. Celebrate cooperation blowing on a pinwheel made of stars! To build it, you can follow the instructions carefully put together by <a
        class="au"
        href="https://spaceplace.nasa.gov/pinwheel-galaxy/en/"
      >NASA</a>.<br> After you made one, try and make a 7 petals pinwheel with no red, like the Cooperacy original logo!</p>
    ...
    <p class="base">You may also imagine new gamifications based on a cooperation-based gameplay, or structured with an ecosystemic thinking approach. To learn more about the possibilities of integrating cooperation in your dynamics or your narratives, have a look at our <a
        class="au"
        href="/cooperation"
      >learning area.</a></p><br><br><br>
  </div>
</template>
