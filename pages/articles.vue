<template>
  <div class="page-container">
    ...
    <p class="base">
      Our project articles propose a definition of cooperation based on an
      interdisciplinary constructs model, being compared on international
      indicators PLS analysis, social representation, Facebook groups real and
      relational benefits analysis, game theory dual benefit analysis and
      subsequent mathematical model theorization:<br /><br />
      <br />
      - Conference paper, MIT Collective Intelligence Conference 2015,
      University of Michigan - Ann Arbor - Centre for Complex Systems, held in
      Santa Clara, Silicon Valley<br />
      - Conference paper, MIT Collective Intelligence Conference 2016, New York
      University Stern School of Business<br />
      - In publication: Cooperation and Collective Intelligence, LabGov and IASC
      selection from the Conference of Urban Commons, Bologna<br />
      - Cooperation: the Art of Mutual Enjoyment, Springer<br />
      - Conference paper, Partial Least Square 2017 international conference,
      Introducing a Cooperation Context Index for countries<br />
      <br />
    </p>
