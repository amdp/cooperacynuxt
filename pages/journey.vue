<template>
  <div>
    ...
    <p class="base">The Journey is a <a
        class="af"
        href="/aboutyou"
      >personal</a> adventure that flows through the <a
        class="ae"
        href="/cooperation"
      >conditions of cooperation</a> realms. When you <a
        class="ae"
        href="/register"
    ...
    <br>
    <p class="subheading freedom center space margin">THE COOPERATION JOURNEY</p>
    <p class="base">The Journey is also a path of growth for groups. In order to bring improvement and needed changes, the Cooperacy Journey provides a path that follows the seven conditions in order to bring forward all the group or organisation <a
        class="af"
        href="/services"
      >development</a> power. Some companies that have strong rational or pyramidal structures need more equivalence to foster innovation through better internal services instead of leadership changes, while some institutions need more diversity or freedom to shake a little bit the recurring or stagnant processes they face. Family and small groups may need to improve their strange information and decision flows. The Cooperacy Journey follows the same path for learning dedicated group methodologies that bring better <a
        class="ac"
        href="/cooperation#care"
      >coordination</a> of the organization's <a
        class="ad"
        href="/cooperation#diversity"
      >diversities</a> establishing mutual <a
        class="au"
        href="/cooperation#understanding"
      >understanding</a>, resolving <a
        class="af"
        href="/cooperation#freedom"
      >limitations</a>, distributing <a
        class="ai"
        href="/cooperation#transparency"
      >information</a> and rebuilding <a
        class="at"
