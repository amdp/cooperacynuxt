      ...
      <div class="col-12">
        <div class="row">
          ...
          <div class="col-7">
            ...
            <div class="row">
              <div class="col-12 mt-2 minimini up">
                TAGS: <span
                  v-for="tag in this.$store.state.tag"
                  :key="tag.id"
                >{{tag.name}}</span>
                <span>- <b-link
                    v-b-modal.addtagmodal
                    class="ac"
                  >Add</b-link> or
                  <b-link
                    v-b-modal.removetagmodal
                    class="au"
                  >remove</b-link> a tag</span>
              </div>
            </div>
          </div>
          <div class="col-2">
            <div class="row">
              <div
                class="col-12 minimini mt-2"
                v-if="oneproject.anonymous"
              >AFTF ON</div>
              <div
                class="col-12 minimini mt-2"
                v-if="!oneproject.anonymous"
            ...
            <div class="row">
              <div
                class="col-12 mt-2 minimini"
                v-if="oneproject.stage!=5"
              >
