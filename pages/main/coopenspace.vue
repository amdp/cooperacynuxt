<template>
  <div class="page-container">
    ...
    <p class="base">
      ...
      final ideas day. The ideas or the informative topics are written on a
      common board with a time and a space in which they will be discussed. The
      group is "dissected" and "dies" according to a specific narrative, story
      or myth. Its parts form new groups and circles. Now and then an
      "exploration reshuffle" is performed. Coordination and diffusion of
      knowledge are the transformation tools to solve the exposed problems and
