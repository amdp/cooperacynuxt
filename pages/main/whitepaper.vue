  ...
  <div>
    <div class="page-container">
      ...
      <p class="base">
        ...
        the platform largest cooperation, a real ecosystem. Any internal
        activity of Cooperacy is a cooperation as well. Every cooperation can be
        a part of other ones, or their home. All activities generated by the
        platform are coowned by Cooperacy and its comembers.
      </p>
      <!-- COLLECTION FUND -->
      ...
      <p class="base">
        ...
        Every second microeuros are pre-allocated proportionally to the
        cooperation ideas: the more the votes, the more the proportional amount
        of money. The collected funds are pre-allocated until the ideas budget
        is reached. When it happens, the idea turns into an "approval
        cooperation" starting the budget release phase. After the approval phase
        is completed, the idea becomes an "active cooperation", and its profits
        go back to the collection fund.
      </p>
      ...
      <p class="base">
        ...
        receive a three level feedback by the comembers (+,=,-).<br />
