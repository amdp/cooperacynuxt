<template>
  <b-container class="m-0 p-0 pagecontainer">
    <br /><img
      class="page-header"
      src="~/assets/image/page/banners/main/corporate.png"
    />
    ...
    <p class="base">
      ...
      <nuxt-link to="/main/overview" class="af">Overview</nuxt-link> is a
      quantitative tool useful for focused ecosystemic interventions.
      <nuxt-link to="/main/cohackathon" class="af">Cohackathon</nuxt-link> is
      the more productive way to organise a hackaton for your goals. Cooperation
      and ecosystemic thinking
      <nuxt-link to="/main/workshops" class="af">workshops</nuxt-link> may give
